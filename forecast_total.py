...
df = pd.read_csv("data/train/forecast_total.csv", parse_dates=["date"])
...
FEATURES = ["is_weekend", "is_holiday", "day", "month", "year", "weekday", "expected_volume", "expected_volume_lag_1",
