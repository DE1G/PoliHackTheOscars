...
df = pd.read_csv("data/train/forecast_state.csv", parse_dates=["date"])
...
FEATURES = ["state", "is_weekend", "is_holiday", "day", "month", "year", "weekday", "expected_volume", "expected_volume_lag_1",
