...
file_path = "data/train/forecast_category.csv"
df = pd.read_csv(file_path, parse_dates=["date"])


# Select only the required columns
cols = ["date", "category", "expected_volume"]
...
FEATURES = ["category", "expected_volume", "day", "month", "year", "weekday", "expected_volume_lag_1",
